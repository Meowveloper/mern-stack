    ...
    return (
        <div className="bg-gray-300 pt-5 min-w-[100vw] min-h-[100vh]">
            <div className="w-[50%] mx-auto rounded-sm shadow-sm bg-white p-4">
                ...
                <CheckAllAndRemaining todos={todos} setTodos={setTodos}></CheckAllAndRemaining>

                <hr className="my-3" />

                <div className="flex justify-between items-center">
                    <TodoFilters></TodoFilters>
                    <ClearCompletedBtn todos={todos} setTodos={setTodos}></ClearCompletedBtn>
                </div>
            </div>
        </div>
    );
